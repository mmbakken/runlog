      ...
      {hasStravaAccount ? (
        <section className='space-y-2 text-base'>
          {stravaRuns?.length > 0 ? (
            <div>
              <h2>Recent Runs</h2>
              <pre className='max-h-120 min-h-16 w-full overflow-scroll rounded border border-neutral-500 bg-neutral-800 px-2 py-1 font-mono text-sm wrap-break-word sm:w-120'>
